...
// --- IMPORTANT ---
// You need to install react-native-vector-icons and link it:
// npm install react-native-vector-icons
// react-native link react-native-vector-icons (or follow platform-specific instructions)
// If you don't want icons, remove the Icon import and usage.
// --- --- --- ---
...
const SuccessScreen = ({ navigation, route }) => {
  ...
  const navigateToHome = () => {
     // Example logic: Check route params or have separate SuccessScreens
     // if (route.params?.userType === 'needer') {
     //   navigation.navigate('NeederHome');
     // } else {
       navigation.navigate('DonorHome'); // Defaulting to NeederHome for now
     // }
  };
